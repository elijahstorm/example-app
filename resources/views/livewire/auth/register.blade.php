        ...
        <div class="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
            ...
            <div class="xl:ml-20 w-8/12 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
                <form wire:submit.prevent="register">
                    ...
                    <!-- Name input -->
                    <div class="mb-6">
                        <input wire:model.lazy="name" type="text" required
                            class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none @error('name') border-red-500 @enderror"
                    ...
                    <!-- Password input -->
                    <div class="mb-6">
                        <input wire:model.lazy="password" type="password" required
                    ...
                    <div class="mb-6">
                        <input wire:model="passwordConfirmation" type="password" required
                            class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none @error('passwordConfirmation') border-red-500 @enderror"
                            id="passwordConfirmation" name="passwordConfirmation" placeholder="Password Confirmation" />
